<script lang="ts">
    ...
    const drivers = writable<(Conductor & { 
        lastPosition?: { 
            lat: number; 
            lng: number; 
            timestamp: string;
...
drivers.set(latestPositions.map(item => ({
    ...item.conductor,
    lastPosition: {
        lat: item.lat,
        lng: item.lng,
    ...
    <div class="drivers-list">
        ...
        <div class="driver-cards">
            {#each $drivers as driver}
                <div class="driver-card" on:click={() => {
                    ...
                    <div class="driver-info">
                        ...
                        {#if driver.lastPosition}
                            <p><strong>Última posición:</strong> {new Date(driver.lastPosition.timestamp).toLocaleString()}</p>
                        {/if}
                    </div>
                </div>
            {/each}
